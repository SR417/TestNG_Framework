...
public class TryCatch {
	...
	// Syntax
	 ...
	 try {
	   ...
	   e.printStackTrace();
	   System.out.println("please try to acess the proper values");
	  
	  }
	      catch(ArithmeticException e) {
	  
	  // e.printStackTrace();
	   System.out.println("please eneter proper value to divide");
	 ...
	 /* try {
	  int a[]= {10,20,30,40,50};
	   ...
	   System.out.println(" pleas en eter proper value");
	   
	  }
	  
	     finally {
	      
	      System.out.println("i am finally block and i will be execute always");
	     }
